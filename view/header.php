    ...
    <div class="container text-center">
        ...
        <div class="menu">
            ...
            <div class="navbars">
                <ul>
                    <li>
                        <h4><a class="navbar" href="index.php">HOME</a></h4>
                    </li>
                    <li>
                        <h4><a class="navbar" href="index.php?act=product">PRODUCT</a></h4>
                    </li>
                    <li>
                        <h4><a class="navbar" href="index.php?act=contact">CONTACT</a></h4>
                    </li>
                    <li>
