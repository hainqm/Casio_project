<div class="container">
    <img src="view/imgs/about" class="img-fluid" alt="...">

    <div class="clearfix m-2">
        <img src="view/imgs/company-img09.jpeg" class="col-md-6 float-md-end mb-3 ms-md-3" style="width:500px"
            alt="...">

        <h2><b>Information on the Casio Group's CSR initiatives is available in two useful formats.</b></h2>
